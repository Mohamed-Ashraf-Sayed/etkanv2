  ...
  return (
    <section className="py-24 md:py-32 bg-navy relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-0 w-72 h-72 bg-accent/[0.06] rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2" />
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-accent/[0.06] rounded-full blur-3xl translate-x-1/3 translate-y-1/3" />
        {/* Subtle grid pattern */}
        <div
