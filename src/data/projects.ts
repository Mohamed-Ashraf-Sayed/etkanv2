...
export const projects: Project[] = [
  {
    ...
    title: "موقع شركة عرب فيوتشر للعمارة والمقاولات",
    client: "Arab Future Ltd | عرب فيوتشر المحدودة",
    industry: "العمارة والمقاولات",
    category: "website",
    categoryLabel: "مواقع",
    summary:
      "موقع مؤسسي احترافي لشركة سعودية رائدة في التصميم المعماري والواجهات المسبقة الصنع وترميم المباني التراثية",
    description:
      "صممنا موقعاً مؤسسياً متكاملاً لشركة عرب فيوتشر السعودية يعرض خبرتها الممتدة لأكثر من 12 سنة و350+ مشروع منفذ، مع معرض أعمال شامل وصفحات تفصيلية لكل خدمة.",
    problem:
      "الشركة كانت محتاجة موقع يعكس مكانتها كرائد في مجال التصميم المعماري والواجهات الزخرفية في السعودية، ويعرض مشاريعها الفاخرة ورؤيتها المتوافقة مع رؤية 2030.",
    solution:
      "بنينا موقعاً مؤسسياً ثنائي اللغة بتصميم عصري يبرز الهوية الفاخرة للشركة، مع معرض مشاريع تفاعلي، صفحات خدمات تفصيلية (GRC, GRP, GRG، الأحجار الصناعية)، وقسم رؤية 2030.",
    results: [
      { metric: "سنوات الخبرة", value: "12+", description: "سنة في السوق السعودي" },
      { metric: "المشاريع", value: "350+", description: "مشروع منفذ بنجاح" },
      { metric: "الخدمات", value: "7", description: "خدمات معمارية متكاملة" },
    ],
