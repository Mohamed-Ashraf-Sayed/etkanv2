...
const TITLE = "الدليل الشامل لتطوير المواقع 2026: من الصفر للاحتراف";
const DESCRIPTION =
  "دليل شامل لتطوير المواقع في 2026: التقنيات الحديثة، تكلفة تصميم موقع، خطوات التنفيذ، الفرق بين المواقع، اختيار الشركة، وأمثلة عملية.";
